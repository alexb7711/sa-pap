...
mod test_generators {
    ...
    fn test_schedule_generator() {
        ...
        assert_eq!(charger.schedule[0][1].t, (6.016667, 8.075));
        assert_eq!(charger.schedule[0][1].b, 0);

        assert_eq!(charger.schedule[1][1].t, (6.35, 8.408334));
        assert_eq!(charger.schedule[1][1].b, 1);

        assert_eq!(charger.schedule[2][1].t, (6.6833334, 8.741667));
        assert_eq!(charger.schedule[2][1].b, 2);

        assert_eq!(charger.schedule[18][1].t, (6.8083334, 7.358333));
