...
and lines 9 and 10 add it to the set of candidates. Line 14 chooses picks a candidate solution, $\I_i' \subset \I'$,
with a discrete uniform distribution which is denoted by $\U_{\{\cdot\}}$.
